...
const ImageSlideshow = ({ images, coverImage }) => {
  ...
  if (displayImages.length === 0) {
    return <img src="https://tse1.mm.bing.net/th/id/OIP.mtFzdGV6x4bKHCxjmS7yrQHaF4?pid=Api&P=0&h=180" alt="No Image Available" className="w-full h-64 sm:h-80 md:h-96 object-contain" />;
  }
