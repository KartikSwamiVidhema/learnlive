...
//       <p className="text-gray-500">Give your visitor a smooth online experience with a solid UX design</p>

    
//       <p className="mt-4 text-gray-700">
//       These General Terms and Conditions govern your use of the iThemes.xyz website https://ithemes.xyz/ and the purchase and use of website, iOS, and Android themes (“Themes”) provided by iThemes.xyz. By accessing the Website and using our services, you agree to abide by these Terms. Please read them carefully.
//       </p>

//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 1. Acceptance of Terms</h3>
//         <p className="mt-2 text-gray-700">
//         You indicate that you have read, understood, and agree to abide by these Terms by using the Website and purchasing or downloading Themes. Please refrain from using our website or themes if you disagree with any aspect of these terms.
//         </p>
//       </section>
//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 2. Use of Themes</h3>
//         <p className="mt-2 text-gray-700">
...
//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 3. Account Registration</h3>
//         <p className="mt-2 text-gray-700">
//         You might need to register for an account in order to use some Website features and buy Themes. You are in charge of protecting the privacy of your account information and of any actions taken in connection with your account.
// During the registration process, you promise to give accurate, current, and complete information. You also commit to update this information as necessary to keep it accurate, current, and complete.
//         </p>
//       </section>

//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 4. Pricing and Payment</h3>
//         <p className="mt-2 text-gray-700">
//         The prices for Themes are posted on the website and are subject to change at any time without prior notice. It is your responsibility to check the pricing range before making any purchases.Through our chosen payment provider, payments for Themes are performed safely. The rules and conditions of the payment processor apply to payment information.
//         </p>
//       </section>

//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 5. Refund Policy</h3>
//         <p className="mt-2 text-gray-700">
//         Refunds for purchased Themes are subject to our refund policy, which is available on the Website. Please review this policy before making a purchase.
//         </p>
//       </section>


//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 6. Intellectual Property</h3>
//         <p className="mt-2 text-gray-700">
//         All Themes, content, and materials available on the Website are protected by copyright and other intellectual property laws. You may not reproduce, distribute, or create derivative works based on our Themes or content without our prior written consent.
//         </p>
//       </section>

//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 7. Disclaimer of Warranties</h3>
//         <p className="mt-2 text-gray-700">
//         Themes and content are provided “as is” and “as available” by iThemes.xyz. Regarding the truthfulness, dependability, or fitness of the themes or content for any purpose, we make no guarantees, either stated or implied. We do not promise that there won’t be any glitches, disruptions, or security flaws with the Website or Themes. At your own risk, you use our website and themes.
//         </p>
//       </section>

//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 8. Limitation of Liability</h3>
//         <p className="mt-2 text-gray-700">
//         iThemes.xyz disclaims all liability for any direct, indirect, incidental, special, or consequential damages that may result from the use of or inability to use our website or themes.In no circumstances will our total responsibility exceed the price you paid for the disputed Themes or services.
//         </p>
//       </section>

//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 9. Privacy Policy</h3>
//         <p className="mt-2 text-gray-700">
//         Our Privacy Policy, which outlines how we collect, use, and safeguard your personal information, also governs how you use the Website and Themes.
//         </p>
//       </section>

//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 10. Termination</h3>
//         <p className="mt-2 text-gray-700">
...
//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 11. Governing Law</h3>
//         <p className="mt-2 text-gray-700">
...
//       <section className="mt-6">
//         <h3 className="flex items-center text-lg font-semibold"> 12. Contact Information</h3>
//         <p className="mt-2 text-gray-700">
